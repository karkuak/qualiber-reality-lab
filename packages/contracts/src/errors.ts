...
export const CODES = {
  ...
  /**
   * A later command tried to change the subject seam the run froze at
   * preregistration — introducing a real adapter into a fake-port run, or
   * dropping the adapter from a real one (ADR-ERL2-036, review P1).
   */
  ADMISSION_SUBJECT_EXECUTION_MODE_FROZEN: "ADMISSION_SUBJECT_EXECUTION_MODE_FROZEN",
  ...
  ADAPTER_PROTOCOL_DOWNGRADE_REFUSED: "ADAPTER_PROTOCOL_DOWNGRADE_REFUSED",
  ...
  ADAPTER_EXECUTION_MODE_UNSUPPORTED: "ADAPTER_EXECUTION_MODE_UNSUPPORTED",
  ADAPTER_LOCAL_CONTEXT_FORBIDDEN: "ADAPTER_LOCAL_CONTEXT_FORBIDDEN",
  ADAPTER_LOCAL_LIMIT_EXCEEDED: "ADAPTER_LOCAL_LIMIT_EXCEEDED",
  ADAPTER_LOCAL_OPERATION_ORDER_INVALID: "ADAPTER_LOCAL_OPERATION_ORDER_INVALID",
  ADAPTER_LOCAL_REPLAY_CONFLICT: "ADAPTER_LOCAL_REPLAY_CONFLICT",
  ADAPTER_LOCAL_AMBIGUOUS_REPLAY_REFUSED: "ADAPTER_LOCAL_AMBIGUOUS_REPLAY_REFUSED",
  ADAPTER_LOCAL_CLEANUP_INCOMPLETE: "ADAPTER_LOCAL_CLEANUP_INCOMPLETE",
  ADAPTER_LOCAL_RESIDUE_REPORT_INVALID: "ADAPTER_LOCAL_RESIDUE_REPORT_INVALID",

  // -- owner-operated trusted-local development path (ADR-ERL2-042) ----------
  // These name an owner's own assertion. None of them reports a certification
  // outcome, and none may be reused to describe one.
  ADAPTER_TRUSTED_LOCAL_DECLARATION_REQUIRED: "ADAPTER_TRUSTED_LOCAL_DECLARATION_REQUIRED",
  ADAPTER_TRUSTED_LOCAL_ACKNOWLEDGEMENT_INVALID: "ADAPTER_TRUSTED_LOCAL_ACKNOWLEDGEMENT_INVALID",
  ADAPTER_TRUSTED_LOCAL_BINDING_MISMATCH: "ADAPTER_TRUSTED_LOCAL_BINDING_MISMATCH",
  ADAPTER_TRUSTED_LOCAL_AUTHORITY_MISMATCH: "ADAPTER_TRUSTED_LOCAL_AUTHORITY_MISMATCH",
  ADAPTER_TRUSTED_LOCAL_CLAIM_CEILING_EXCEEDED: "ADAPTER_TRUSTED_LOCAL_CLAIM_CEILING_EXCEEDED",
  ADAPTER_TRUSTED_LOCAL_RECORD_INVALID: "ADAPTER_TRUSTED_LOCAL_RECORD_INVALID",
  ADAPTER_TRUSTED_LOCAL_RECORD_OVERSIZED: "ADAPTER_TRUSTED_LOCAL_RECORD_OVERSIZED",
  ADAPTER_TRUSTED_LOCAL_PLAN_BYTES_REQUIRED: "ADAPTER_TRUSTED_LOCAL_PLAN_BYTES_REQUIRED",
  ADAPTER_REQUEST_PREDECESSOR_INVALID: "ADAPTER_REQUEST_PREDECESSOR_INVALID",
